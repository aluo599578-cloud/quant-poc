"""
double_ma_stop_loss_lean.py — 双均线 + 5% 止损
==============================================
"""
...
class DoubleMaStopLossLean(CtaTemplate):
    """双均线 + 5% 止损 (Lean 风格)"""
    ...
    parameters = ["fast_window", "slow_window", "stop_loss_pct", "fixed_size", "warmup_bars"]
    variables = ["fast_ma0", "slow_ma0", "bar_count", "entry_price"]

    def on_init(self):
        self.write_log("双均线+止损 Lean 策略初始化")
